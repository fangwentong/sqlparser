...
func TestNormalize(t *testing.T) {
	...
	testcases := []struct {
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.StringBindVariable("aa"),
		},
	}, {
		// placeholder
		...
		outstmt: "select * from t where v1 = :bv1",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.Int64BindVariable(1),
		},
	}, {
		// float val
		...
		outstmt: "select * from t where v1 = :bv1",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.DecimalBindVariable(1.2),
		},
	}, {
		// multiple vals
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.DecimalBindVariable(1.2),
			"bv2": sqltypes2.Int64BindVariable(2),
		},
	}, {
		// bv collision
		...
		outstmt: "select * from t where v1 = :bv1 and v2 = :bv2",
		outbv: map[string]*querypb.BindVariable{
			"bv2": sqltypes2.Int64BindVariable(1),
		},
	}, {
		// val reuse
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.Int64BindVariable(1),
			"bv2": sqltypes2.StringBindVariable("1"),
		},
	}, {
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.Int64BindVariable(5),
			"bv2": sqltypes2.Int64BindVariable(5),
			"bv3": sqltypes2.Int64BindVariable(5),
		},
	}, {
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.Int64BindVariable(5),
			"bv2": sqltypes2.TestBindVariable([]interface{}{1, 4, 5}),
		},
	}, {
		...
		outstmt: "select * from t where v1 = :bv1",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.HexNumBindVariable([]byte("0x1234")),
		},
	}, {
		...
		outstmt: "select * from t where v1 = :bv1",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.HexValBindVariable([]byte("x'7b7d'")),
		},
	}, {
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.HexNumBindVariable([]byte("0x12")),
		},
	}, {
		...
		outstmt: "select * from t where v1 = :bv1 and v2 = :bv1",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.StringBindVariable(fmt.Sprintf("%256s", "a")),
		},
	}, {
		...
		outstmt: "select * from t where v1 = :bv1 and v2 = :bv2",
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.StringBindVariable(fmt.Sprintf("%257s", "b")),
			"bv2": sqltypes2.StringBindVariable(fmt.Sprintf("%257s", "b")),
		},
	}, {
		// bad int
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.TestBindVariable([]interface{}{1, "2"}),
		},
	}, {
		// NOT IN clause
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.StringBindVariable("test"),
		},
	}, {
		// insert syntax
		...
		outbv: map[string]*querypb.BindVariable{
			"bv1": sqltypes2.Int64BindVariable(1),
			"bv2": sqltypes2.StringBindVariable("2"),
			"bv3": sqltypes2.Int64BindVariable(3),
		},
	}}
