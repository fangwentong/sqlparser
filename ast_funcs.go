...
import (
	...
	"github.com/xwb1989/sqlparser/internal/dependency/vt/log"
	querypb "github.com/xwb1989/sqlparser/internal/dependency/vt/proto/query"
	vtrpcpb "github.com/xwb1989/sqlparser/internal/dependency/vt/proto/vtrpc"
	"github.com/xwb1989/sqlparser/internal/dependency/vt/vterrors"
	"regexp"
	"strings"
)
...
func (ct *ColumnType) SQLType() querypb.Type {
	...
	case keywordStrings[TINYINT]:
		if ct.Unsigned {
			return sqltypes2.Uint8
		}
		return sqltypes2.Int8
	case keywordStrings[SMALLINT]:
		if ct.Unsigned {
			return sqltypes2.Uint16
		}
		return sqltypes2.Int16
	case keywordStrings[MEDIUMINT]:
		if ct.Unsigned {
			return sqltypes2.Uint24
		}
		return sqltypes2.Int24
	case keywordStrings[INT], keywordStrings[INTEGER]:
		if ct.Unsigned {
			return sqltypes2.Uint32
		}
		return sqltypes2.Int32
	case keywordStrings[BIGINT]:
		if ct.Unsigned {
			return sqltypes2.Uint64
		}
		return sqltypes2.Int64
	case keywordStrings[BOOL], keywordStrings[BOOLEAN]:
		return sqltypes2.Uint8
	case keywordStrings[TEXT]:
		return sqltypes2.Text
...
func encodeSQLString(val string) string {
	return sqltypes2.EncodeStringSQL(val)
}
